...
class Sla_bra extends CI_Controller {
    var $data = array();
    ...
    public function index() {
		$this->data['active_menu'] = "sla_bra";
		
        $data = json_decode($this->curl->simple_get(rest_api().'/sla_bra_report/get_data'), true);
        $this->data['data_sla_bra'] =  $data;
        
        return view('admin/sla_bra/index', $this->data);
    }
