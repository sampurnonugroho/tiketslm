...
class Rdpcit_bra extends CI_Controller {
    var $data = array();
    ...
    public function index() {
        $this->data['active_menu'] = "rdpcit_bra";
        ...
        return view('admin/rdpcit_bra/index', $this->data);
    }

    public function add() {
        $this->data['active_menu'] = "rdpcit_bra";
		$this->data['url'] = "rdpcit_bra/save";
		$this->data['flag'] = "add";
        ...
        return view('admin/rdpcit_bra/form', $this->data);
    }
	...
	function save() {
		...
		$this->db->insert('rdpcit_bra', $data);
	...
	public function edit($id) {
		$this->data['active_menu'] = "rdpcit_bra";
		$this->data['url'] = "rdpcit_bra/update";
		$this->data['flag'] = "edit";
		
		$sql = "SELECT * FROM rdpcit_bra WHERE id_user = '$id'";
	...
	function detail_foto() {
		...
		return view('admin/rdpcit_bra/detail_foto', $this->data);
	}
}