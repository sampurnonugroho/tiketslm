...
class Handover_in extends CI_Controller {
    var $data = array();
	...
	public function index() {
        $this->data['active_menu'] = "handover_in";
		...
		return view('admin/handover_in/index', $this->data);
    }
	...
	public function add_ho() {
		$this->data['active_menu'] = "handover_in";
		$this->data['url'] = "handover_in/save";
		$this->data['flag'] = "add";
        ...
        return view('admin/handover_in/form', $this->data);
	}
	...
	public function show_form() {
		...
		return view('admin/handover_in/show_form', $this->data);
	}
	...
	public function update_data() {
		...
		$status = json_decode($this->curl->simple_get(rest_api().'/select/query', array('query'=>
			"SELECT status FROM client_ho WHERE id='$id'"
	...
	public function add() {
		...
		return view('admin/handover_in/form2', $this->data);
	}
	...
	public function edit($id) {
		$this->data['active_menu'] = "handover_in";
		$this->data['url'] = "handover_in/update";
		$this->data['flag'] = "edit";
