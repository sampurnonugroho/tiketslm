...
class Admcit_nas extends CI_Controller {
    var $data = array();
    ...
    public function index() {
        $this->data['active_menu'] = "admcit_nas";
        ...
        return view('admin/admcit_nas/index', $this->data);
    }

    public function add() {
        $this->data['active_menu'] = "admcit_nas";
		$this->data['url'] = "admcit_nas/save";
		$this->data['flag'] = "add";
        ...
        return view('admin/admcit_nas/form', $this->data);
    }
	...
	function save() {
		...
		$this->db->insert('admcit_nas', $data);
	...
	public function edit($id) {
		$this->data['active_menu'] = "admcit_nas";
		$this->data['url'] = "admcit_nas/update";
		$this->data['flag'] = "edit";
		
		$sql = "SELECT * FROM admcit_nas WHERE id_user = '$id'";
	...
	function detail_foto() {
		...
		return view('admin/admcit_nas/detail_foto', $this->data);
	}
}