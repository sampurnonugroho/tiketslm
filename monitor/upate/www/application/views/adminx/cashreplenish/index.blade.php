					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: center">
								<button type="button" class='button green' onClick="window.location.href='<?php echo base_url();?>cashreplenish/edit/<?php echo $row->id_ct;?>'" title='Edit'><span class='smaller'>Detail</span></button>
								<?php if($level=="ADMIN") { ?>
