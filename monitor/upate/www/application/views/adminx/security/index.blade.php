										...
										<tbody>
											...
											<tr>
												...
												<td style="text-align: center">
													<button type="button" class='button green' onClick="window.location.href='<?php echo base_url();?>security/edit/<?php echo $row->id_ct;?>#&tab-hsc'" title='Edit'><span class='smaller'>View Detail Data</span></button>
												</td>
											</tr>
											<?php 
												endforeach; 
