								...
								<td>
									<?php 
										if($row->accept_time==null && $row->data_solve=="") {
											echo '<span class="badge_style b_low">Waiting PIC</span>';
									...
									<!--<span class="badge_style b_low">Pending</span>
									<span class="badge_style b_medium">Pending</span>
									<span class="badge_style b_high">Pending</span>
									
									<span class="badge_style b_done">Pending</span>
									<span class="badge_style b_away">Pending</span>
