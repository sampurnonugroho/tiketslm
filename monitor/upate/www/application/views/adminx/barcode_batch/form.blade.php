				...
				<form class="block-content form" id="karyawanForm" method="post" action="<?php echo base_url();?><?php echo $url;?>">
					<fieldset class="grey-bg required">
						...
						<p>
							...
							<input type="text" class="full-width" name="barcode" value="<?=$batch_barcode?>" readonly>
						</p>
						<p>
							<label>Barcode Purposes</label>
							<input type="text" class="full-width" name="purposes" value="" required>
						</p>
						<p>
							<label>Client Distribution</label>
							<select name="client" class="js-example-basic-single full-width" required>
						...
						<p>
							...
							<input type="text" class="full-width" name="lokasi" value="" required>
						</p>
						<p>
							<label>ID Branch</label>
							<select name="branch" class="js-example-basic-single2 full-width" required>
						...
						<p>
							...
							<select name="area" class="js-example-basic-single3 full-width" required>
						...
						<p>
							<label>Bag Seal</label>
							<input type="text" class="full-width" name="bag_seal" value="" required>
						</p>
						<p>
							<label>Note</label>
							<input type="text" class="full-width" name="note" value="" required>
						</p>
	...
	<script>
		...
		jq341(document).ready(function()
		{
			...
			jq341('.js-example-basic-single').select2({
				...
				ajax: {
					dataType: 'json',
					url: '<?php echo base_url().'select/select_bank2'?>',
					delay: 250,
					type: "POST",
