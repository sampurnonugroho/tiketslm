		...
		<script>
			...
			jq341(document).ready(function() {
				...
				for(var i=1; i<=cart; i++) {
					if(i==1) {
						...
						row2 +=   '<tr>'+
							  ...
							  '<td style="border: 0px">:</td>'+
							  '<td style="border: 0px; padding: 10px 15px 5px 0px"><input name="cart_'+i+'_val" style="height: 28px" value=""  class="easyui-validatebox tb" type="text" required="true"></td>'+
							  '</tr>';
					}
					if(i==2) {
				...
				row2 +=   '<tr>'+
						  ...
						  '<td style="border: 0px">:</td>'+
						  '<td style="border: 0px; padding: 10px 15px 5px 0px"><input name="div_val" style="height: 28px" value=""  class="easyui-validatebox tb" type="text" required="true"></td>'+
						  '</tr>';
