<?php $__env->startSection('content'); ?>
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-left">
			<button type="button" onclick="window.location.href='<?=base_url()?>cashtransit'"><img src="<?=base_url()?>assets/constellation/assets/images/icons/fugue/navigation-180.png" width="16" height="16"> Back</button>
		</div>
	</div></div>
	<!-- End control bar -->
