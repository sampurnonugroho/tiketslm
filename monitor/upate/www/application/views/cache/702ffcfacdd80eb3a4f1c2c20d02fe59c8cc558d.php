	...
	<div>
		...
		<table class="dv-table" style="float:left;border:0px solid #ccc;padding:5px;margin-top:5px;width:auto">
			<tr>
				<td>BIG SEAL</td>
				<td>:</td>
				<td style="border: 0px; padding: 10px 15px 5px 0px"><input name="" id="bag_seal_atm_<?=$index?>" value="<?=$row->bag_seal?>" style="height: 28px" class="easyui-validatebox easyui-textbox" required="true"></input></td>
			</tr>
			<tr>
				<td>BAG NO</td>
				<td>:</td>
				<td style="border: 0px; padding: 10px 15px 5px 0px"><input name="" id="bag_no_atm_<?=$index?>" value="<?=$row->bag_no?>" style="height: 28px" class="easyui-validatebox easyui-textbox" required="true"></input></td>
			</tr>	
			<tr>
				<td>CASHIER</td>
				<td>:</td>
