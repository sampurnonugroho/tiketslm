						...
						<div class=" page_content">
							<div class="invoice_container">
								...
								<div class="grid_12 invoice_title">
									<center><img src="<?=base_url()?>assets/constellation/assets/images/bijak.png" width="50" height="50">
								</center>
								<p align="center"><b>PT. BINTANG JASA ARTHA KELOLA</b>
								<br>ACTUAL DAILY MONITORING
								<br>[ CASH IN TRANSIT - NASIONAL ]</p>
								</div>
									...
									<div class="invoice_tbl">
										...
										<tr>
											...
											<td>
												...
												<a href="<?=base_url()?>admcit_nas/detail_foto/<?=$row->id_detail?>"><button style="font-size: 10px">Detail Foto</button></a>
												<a href="#" class="detail_previews"><button style="font-size: 10px">Detail</button></a>
											</td>
										</tr>
										<?php 
											}
