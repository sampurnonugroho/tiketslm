		...
		<div id="sidebar">
			<div id="secondary_nav">
				<ul id="sidenav" class="accordion_mnu collapsible orange_f">
					...
					</span> Actual Daily Monitoring <span class="down_arrow">&nbsp;</span></a>
						<ul class="acitem">
							...
							<li><a class="<?=($active_menu == "rekon_atm" ? 'active' : '')?>" href="<?=base_url()?>rekon_atm/get_data4"><span class="list-icon">&nbsp;</span>Rekon ATM</a></li>
						</ul>
					</li>
					...
					<li <?php if($active_menu=="cashtransit" 
						...
						<ul class="acitem">
							...
							<li><a class="<?=($active_menu == "handover" ? 'active' : '')?>" href="<?=base_url()?>handover"><span class="list-icon">&nbsp;</span>HO</a></li>
							...
							<li><a class="<?=($active_menu == "handoverh0" ? 'active' : '')?>" href="<?=base_url()?>handover"><span class="list-icon">&nbsp;</span>HO</a></li>
					...
					<li <?php if($active_menu=="barcode_batch" 
									...
									|| $active_menu=="seal"
									|| $active_menu=="bag"
									|| $active_menu=="tbag") { echo 'class="expand"'; } ?>><a href="#"><span class="nav_icon computer_imac"></span> Logistics & Identity</a>
						<ul class="acitem">
							...
							<li><a class="<?=($active_menu == "tbag" ? 'active' : '')?>" href="<?=base_url()?>tbag"><span class="list-icon">&nbsp;</span>Data T-Bag</a></li>
							<li><a class="<?=($active_menu == "tbag" ? 'active' : '')?>" href="<?=base_url()?>tbag"><span class="list-icon">&nbsp;</span>Data Cassette</a></li>
						</ul>
					</li>
					<li <?php if($active_menu=="client" 
						...
						<ul class="acitem">
							...
							<li><a class="<?=($active_menu == "client_cit" ? 'active' : '')?>" href="<?=base_url()?>client_cit"><span class="list-icon">&nbsp;</span>Client CIT</a></li>
					...
					<!--<li <?php if($active_menu=="cashtransit" 
									|| $active_menu=="cashreplenish") { echo 'class="expand"'; } ?>><a href="#"><span class="nav_icon computer_imac"></span> Planning & Preparation <span class="up_down_arrow">&nbsp;</span></a>
						<ul class="acitem">
							<li><img src="<?=base_url()?>constellation/assets/images/icons/fugue/status.png" width="20" height="20" style="margin-top:10px;"><b style="font-size: 12px; color:#ffffff;"> Cash In Transit (CIT)</b></li><br>
					...
					<!--<li><a href="#"><span class="nav_icon computer_imac"></span> Actual Daily Monitoring <span class="up_down_arrow">&nbsp;</span></a>
						<ul class="acitem">
							<li><img src="<?=base_url()?>constellation/assets/images/icons/fugue/status.png" width="20" height="20" style="margin-top:10px;"><b style="font-size: 12px; color:#ffffff;"> ATM FLM & SLM </b></li><br>
							<li><a href="javascript:void(0)"><span class="list-icon">&nbsp;</span>FLM & SLM - Nasional</a></li>
							<li><a href="javascript:void(0)"><span class="list-icon">&nbsp;</span>FLM & SLM - Branch</a></li>
					...
					<!--<li <?php if($active_menu=="ticket_list" 
									...
									|| $active_menu=="myassignment_list") { echo 'class="expand"'; } ?>><a class="active" href="#"><span class="nav_icon computer_imac"></span> Tickets Management <span class="up_down_arrow">&nbsp;</span></a>
						<ul class="acitem">
