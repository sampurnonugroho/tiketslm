	...
	<section class="grid_12">
			<div class="block-border"><form class="block-content form" id="complex_form" method="post" action="#">
				...
				<table id="dg" class="easyui-datagrid" title="Cash Transit" style="width:100%;height:550px"
					data-options="rownumbers:true,singleSelect:true,url:'',method:'get'" pagination="true">
					<thead>
						<tr>
							<th data-options="field:'id',width:50">ID</th>
							<th data-options="field:'branch',width:150">BRANCH</th>
							<th data-options="field:'ga',width:50">GA</th>
							<th data-options="field:'bank',width:100">BANK</th>
							<th data-options="field:'petty_cash',width:100">ACT</th>
							<th data-options="field:'petty_cash',width:100">BRAND</th>
							<th data-options="field:'petty_cash',width:100">MODEL</th>
							<th data-options="field:'petty_cash',width:150">LOCATION</th>
							<th data-options="field:'petty_cash',width:100">100K</th>
							<th data-options="field:'petty_cash',width:100">50K</th>
							<th data-options="field:'petty_cash',width:100">20K</th>
							<th data-options="field:'petty_cash',width:100">10K</th>
							<th data-options="field:'petty_cash',width:100">1K</th>
							<th data-options="field:'petty_cash',width:100">COIN</th>
							<th data-options="field:'petty_cash',width:50">TOTAL CART</th>
							<th data-options="field:'petty_cash',width:250">NOMINAL</th>
