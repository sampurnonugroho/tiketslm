				...
				<div id="control-bar">
					<div class="container_16">
						...
						<div class="float-right">
							<button type="button" onClick="window.location.href='<?=base_url()?>barcode_generates/add'">Add Data</button>
						</div>
						<center>
					...
					<table class="display data_tbl">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span><a class="action-icons c-edit" onClick="window.location.href='<?php echo base_url();?>barcode_generates/print_barcode/<?php echo $row['batch'];?>'" href="#" title="Edit">Edit</a></span>
								</td>
							</tr>
							<?php 
								endforeach; 
