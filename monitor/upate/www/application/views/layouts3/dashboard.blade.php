...
<body class="bg-theme bg-theme1">
                    ...
                    <div class="col-12 col-lg-6 col-xl-8">
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>assets/images/avatars/avatar-13.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>assets/images/avatars/avatar-15.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>assets/images/avatars/avatar-14.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>assets/images/avatars/avatar-16.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        <img src="<?=base_url()?>assets/images/avatars/avatar-17.png" alt="user avatar" class="customer-img rounded-circle">
                                        <div class="media-body ml-3">
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Iphone 5</td>
                                            <td><img src="<?=base_url()?>assets/images/products/01.png" class="product-img" alt="product img"></td>
                                            <td>#9405822</td>
                                            <td>$ 1250.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Earphone GL</td>
                                            <td><img src="<?=base_url()?>assets/images/products/02.png" class="product-img" alt="product img"></td>
                                            <td>#9405820</td>
                                            <td>$ 1500.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?=base_url()?>assets/images/products/03.png" class="product-img" alt="product img"></td>
                                            <td>#9405830</td>
                                            <td>$ 1400.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Clasic Shoes</td>
                                            <td><img src="<?=base_url()?>assets/images/products/04.png" class="product-img" alt="product img"></td>
                                            <td>#9405825</td>
                                            <td>$ 1200.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Hand Watch</td>
                                            <td><img src="<?=base_url()?>assets/images/products/05.png" class="product-img" alt="product img"></td>
                                            <td>#9405840</td>
                                            <td>$ 1800.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Clasic Shoes</td>
                                            <td><img src="<?=base_url()?>assets/images/products/06.png" class="product-img" alt="product img"></td>
                                            <td>#9405825</td>
                                            <td>$ 1200.00</td>
                                            <td>03 Aug 2017</td>
                                            <td>
    ...
    <!-- loader scripts -->
    <script src="<?=base_url()?>assets/js/jquery.loading-indicator.html"></script>
    <!-- Custom scripts -->
