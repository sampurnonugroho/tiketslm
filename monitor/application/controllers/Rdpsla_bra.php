...
class Rdpsla_bra extends CI_Controller {
    var $data = array();
    ...
    public function index() {
		$this->data['active_menu'] = "rdpsla_bra";
		
        $data = json_decode($this->curl->simple_get(rest_api().'/rdpsla_bra_report/get_data'), true);
        $this->data['data_rdpsla_bra'] =  $data;
        
        return view('admin/rdpsla_bra/index', $this->data);
    }
    ...
    public function index3() {
		...
		$this->data['data_rdpsla_bra'] =  $list;
