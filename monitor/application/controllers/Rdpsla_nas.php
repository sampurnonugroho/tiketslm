...
class Rdpsla_nas extends CI_Controller {
    var $data = array();
    ...
    public function index() {
		$this->data['active_menu'] = "rdpsla_nas";
		
        $data = json_decode($this->curl->simple_get(rest_api().'/rdpsla_nas_report/get_data'), true);
        $this->data['data_rdpsla_nas'] =  $data;
        
        return view('admin/rdpsla_nas/index', $this->data);
    }
    ...
    public function index3() {
		...
		$this->data['data_rdpsla_nas'] =  $list;
