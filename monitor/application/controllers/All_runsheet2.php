...
class All_runsheet2 extends CI_Controller {
    ...
    public function index() {    
		...
		$date = (isset($_REQUEST['datea']) ? $_REQUEST['datea'] : date('Y-m-d'));
		// $date = '2020-02-05';
		...
		return view('admin/all_runsheet2/index', $this->data);
    }
    ...
    public function stock() {    
		...
		return view('admin/all_runsheet2/index_stock', $this->data);
	}
    ...
    public function detail($id) {    
		...
		return view('admin/all_runsheet2/index_detail', $this->data);
    }
