...
class Rdpcr_bra extends CI_Controller {
    var $data = array();
    ...
    public function index() {
        $this->data['active_menu'] = "rdpcr_bra";

        $this->data['data_user'] = $this->model_app->datauser();
        return view('admin/rdpcr_bra/index', $this->data);
    }

    public function add() {
        $this->data['active_menu'] = "rdpcr_bra";
		$this->data['url'] = "rdpcr_bra/save";
		$this->data['flag'] = "add";
        ...
        return view('admin/rdpcr_bra/form', $this->data);
    }
	...
	public function edit($id) {
		$this->data['active_menu'] = "rdpcr_bra";
		$this->data['url'] = "rdpcr_bra/update";
		$this->data['flag'] = "edit";
		
		$sql = "SELECT * FROM rdpcr_bra WHERE id_user = '$id'";
