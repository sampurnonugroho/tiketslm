...
class admcit_bra extends CI_Controller {
    var $data = array();
    ...
    public function index() {
        $this->data['active_menu'] = "admcit_bra";

        $this->data['data_user'] = $this->model_app->datauser();
        return view('admin/admcit_bra/index', $this->data);
    }

    public function add() {
        $this->data['active_menu'] = "admcit_bra";
		$this->data['url'] = "admcit_bra/save";
		$this->data['flag'] = "add";
        ...
        return view('admin/admcit_bra/form', $this->data);
    }
	...
	function save() {
		...
		$this->db->insert('admcit_bra', $data);
	...
	public function edit($id) {
		$this->data['active_menu'] = "admcit_bra";
		$this->data['url'] = "admcit_bra/update";
		$this->data['flag'] = "edit";
		
		$sql = "SELECT * FROM admcit_bra WHERE id_user = '$id'";
