...
class Handover extends CI_Controller {
	...
	public function index() {
        $this->data['active_menu'] = "handover2";
		...
		$this->data['handover2'] = $result;
		
		return view('admin/handover2/index', $this->data);
    }
	...
	public function add_ho() {
        ...
        return view('admin/handover2/form', $this->data);
	}
	...
	public function show_form() {
		...
		return view('admin/handover2/show_form', $this->data);
	}
	...
	public function add() {
		...
		return view('admin/handover2/form2', $this->data);
	}
	...
	public function edit($id) {
		$this->data['active_menu'] = "handover2";
		$this->data['url'] = "handover2/update";
		$this->data['flag'] = "edit";
