			...
			<div class="block-border">
				...
				<form class="block-content form" id="karyawanForm" method="post" action="<?php echo base_url();?><?php echo $url;?>">
					...
					<fieldset class="grey-bg required">
						<legend>Input Data/Name Merk</legend>
						
						<p>
							<label for="simple-action">Merk Name</label>
							<input required type="text" name="merk" id="merk" value="<?php echo $merk;?>" class="full-width">
						</p>
