...
<form method="post">
	<div>
		...
		<table class="dv-table3" style="float:left;padding:50px;margin-top:2px; width: 300px">
			<tr>
				<td>&nbsp TIKET CLIENT</td>
				<td>&nbsp </td>
				<td><input name="ticket_client" id="ticket_client" style="margin: 0px; padding-top: 0px; padding-bottom: 0px; height: 30px; line-height: 45px; width: 100%;" class="easyui-validatebox easyui-textbox"></input></td>
			</tr>	
			<tr>
				<td>&nbsp EMAIL TIME</td>
				<td>&nbsp </td>
				<td>
					<input class="easyui-datetimebox" style="margin: 0px; padding-top: 0px; padding-bottom: 0px; height: 30px; line-height: 45px; width: 100%;" name="email_date" data-options="required:true,showSeconds:true" style="width:150px">
				</td>
			</tr>	
			<tr>
			...
			<tr>
				<td>&nbsp SECURITY AND GUARD</td>
				<td>&nbsp </td>
				<td>
					<select name="guard" class="easyui-validatebox guard" style="width: 100%" required="true">
						<option value="">- select -</option>
					</select>
				</td>
			</tr>	
