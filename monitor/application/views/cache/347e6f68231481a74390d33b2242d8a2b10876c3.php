<?php $__env->startSection('content'); ?>
	...
	<section class="grid_12">
			...
			<div class="block-border"><form class="block-content form" id="complex_form" method="post" action="#">
				<h1>Invalid Seal/Indikasi Fraud</h1>
				<br>
		...
		<div class="float-left">
			...
			<br>
				...
				<table class="table sortableXxx " cellspacing="80" width="100%">
						...
						<tr>
							...
							<?php if($session->userdata['level']=="LEVEL1") { ?>
								<td style="text-align: center">
									<button type="button" class='button green' onClick="window.location.href='<?php echo base_url();?>invalid_seal/process/<?php echo $row->id_ct;?>/<?php echo $row->run_number;?>'" title='Edit'><span class='smaller'>Approve</span></button>
								</td>
							<?php } ?>
						</tr>
						<?php 
