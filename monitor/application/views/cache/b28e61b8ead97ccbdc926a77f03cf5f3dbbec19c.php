<?php $__env->startSection('content'); ?>
	...
	<script>
		...
		var tables = jq3412('#example').DataTable({
			...
			lengthChange: false,
			ajax: {
				url: '<?=base_url()?>cashprocessing/json',
				data: function(data) {
					// Read values
			...
			"columnDefs": [
				...
				{
					"render": function ( data, type, row ) {
						return '<button type="button" class="button green" style="font-size: 12px" onClick="window.location.href=\'<?=base_url()?>cashprocessing/edit/'+data+'\'" title=""><span class="">View Detail Data</span></button>';
					},
					"className": "text-center",
					"targets": 4,
					"searchable": false
