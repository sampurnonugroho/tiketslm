							...
							<tr>
								...
								<?php if($session->userdata['level']=="LEVEL1") { ?>
									<td style="text-align: center">
										<button type="button" class='button green' onClick="window.location.href='<?php echo base_url();?>runsheet/detail_runsheet/<?php echo $row->id_ct;?>#tab-hcp'" title='Edit'><span class='smaller'>View Detail</span></button>
									</td>
								<?php } ?>
							</tr>
							<?php 
