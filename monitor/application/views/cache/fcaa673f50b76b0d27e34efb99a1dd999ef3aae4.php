...
<form method="post">
	<div>
		...
		<?php 
			...
			// print_r($cpc->cashier);
			// print_r(json_decode($cpc->cart_1_no, true)['100']);
		...
		<table class="dv-table3_<?=$index?>" style="float:left;border:0px solid #ccc;padding:5px;margin-top:5px;width:auto">
			<tr>
				<td style="border: 0px; padding: 10px 15px 5px 0px">
					<input name="seal_1_100" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_1_no, true)['100'])?>" data-options="prompt:'100K'" class="easyui-validatebox tb" type="text">
					<input name="seal_1_50" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_1_no, true)['50'])?>" data-options="prompt:'50K'" class="easyui-validatebox tb" type="text">
				</td>
			</tr>
			<tr>
				<td style="border: 0px; padding: 10px 15px 5px 0px">
					<input name="seal_2_100" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_2_no, true)['100'])?>" data-options="prompt:'100K'" class="easyui-validatebox tb" type="text">
					<input name="seal_2_50" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_2_no, true)['50'])?>" data-options="prompt:'50K'" class="easyui-validatebox tb" type="text">
				</td>
			</tr>
			<tr>
				<td style="border: 0px; padding: 10px 15px 5px 0px">
					<input name="seal_3_100" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_3_no, true)['100'])?>" data-options="prompt:'100K'" class="easyui-validatebox tb" type="text">
					<input name="seal_3_50" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_3_no, true)['50'])?>" data-options="prompt:'50K'" class="easyui-validatebox tb" type="text">
				</td>
			</tr>
			<tr>
				<td style="border: 0px; padding: 10px 15px 5px 0px">
					<input name="seal_4_100" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_4_no, true)['100'])?>" style="color:#c6c6c6" data-options="prompt:'100K'" class="easyui-validatebox tb" type="text">
					<input name="seal_4_50" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_4_no, true)['50'])?>" data-options="prompt:'50K'" class="easyui-validatebox tb" type="text">
				</td>
			</tr>
			<tr>
				<td style="border: 0px; padding: 10px 15px 5px 0px">
					<input name="seal_5_100" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_5_no, true)['100'])?>" data-options="prompt:'100K'" class="easyui-validatebox tb" type="text">
					<input name="seal_5_50" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->cart_5_no, true)['50'])?>" data-options="prompt:'50K'" class="easyui-validatebox tb" type="text">
				</td>
			</tr>
			<tr>
				<td style="border: 0px; padding: 10px 15px 5px 0px">
					<input name="div_100" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->div_no, true)['100'])?>" data-options="prompt:'100K'" class="easyui-validatebox tb" type="text">
					<input name="div_50" style="width: 100px; height: 28px;" value="<?=intval(json_decode($cpc->div_no, true)['100'])?>" data-options="prompt:'50K'" class="easyui-validatebox tb" type="text">
				</td>
			</tr>
			<!--<tr id="value_tbag">
				<td style="border: 0px; padding: 10px 15px 5px 0px">
		...
		<table class="dv-table" style="float:left;border:0px solid #ccc;padding:5px;margin-top:5px;width:auto">
			<tr>
				<td>BIG SEAL</td>
				<td>:</td>
				<td style="border: 0px; padding: 10px 15px 5px 0px"><input name="" value="<?=$cpc->bag_seal?>" id="bag_seal_crm_<?=$index?>" style="height: 28px" class="easyui-validatebox easyui-textbox" required="true"></input></td>
			</tr>
			<tr>
				<td>BAG NO</td>
				<td>:</td>
				<td style="border: 0px; padding: 10px 15px 5px 0px"><input name="" value="<?=$cpc->bag_no?>" id="bag_no_crm_<?=$index?>" style="height: 28px" class="easyui-validatebox easyui-textbox" required="true"></input></td>
			</tr>	
			<tr>
				<td>CASHIER</td>
				<td>:</td>
