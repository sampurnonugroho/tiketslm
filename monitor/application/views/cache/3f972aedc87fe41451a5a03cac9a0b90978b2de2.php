			...
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="#">
				...
				<?php if($session->userdata['level']=="LEVEL1") { ?>
					<div class="float-right">
						<button type="button" onClick="window.location.href='<?=base_url()?>branch/add'">Tambah</button>
					</div>
				<?php } ?>
				<table class="table sortable2 " cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<?php if($session->userdata['level']=="LEVEL1") { ?>
								<td>
									<button type="button" class='button green' onClick="window.location.href='<?php echo base_url();?>branch/edit/<?php echo $row->id;?>'" title='Edit'><span class='smaller'>Edit</span></button>
									<button type="button" class='button red' onClick="openDelete('<?php echo $row->id;?>', '<?php echo base_url();?>branch/delete')" title='Delete'><span class='smaller'>Del</span></button>
								</td>
							<?php } ?>
						</tr>
						<?php 
