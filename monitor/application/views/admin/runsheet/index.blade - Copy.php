			...
			$('#dg').datagrid({
				...
				onExpandRow: function(index,row){
					...
					ddv.panel({
						...
						href:'<?=base_url()?>runsheet/show_form?index='+index+'&id_cashtransit='+row.id_ct+'&date='+row.date,
						onLoad:function(){
	...
	<section class="grid_12">
			...
			<div class="block-border"><form class="block-content form" id="complex_form" method="post" action="#">
				...
				<table id="dg" class="easyui-datagrid" title="Cash Transit" style="width:100%;height:550px"
					...
					<thead>
						<tr>
							<th data-options="field:'id_ct',width:250">ID</th>
							<th data-options="field:'date',width:250">DATE</th>
