...
@section('content')
	...
	<div class="block-border">
			...
			<div class="block-border"><form class="block-content form" id="complex_form" method="post" action="#">
				<h1>Data Input Security Control</h1>
				<br>
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: center">
								<button type="button" class='button green' onClick="window.location.href='<?php echo base_url();?>security/edit/<?php echo $row->date;?>'" title='Edit'><span class='smaller'>View Detail Data</span></button>
							</td>
						</tr>
						<?php 
							endforeach; 
	...
	<script>
		...
		var tables = jq3412('#example').DataTable({
			...
			"columnDefs": [
				...
				{
					"render": function ( data, type, row ) {
						return '<button type="button" class="button green" style="font-size: 12px" onClick="window.location.href=\'<?=base_url()?>security/edit/'+row['action_date']+'\'" title=""><span class="">View Detail Data</span></button>';
					},
					"className": "text-center",
					"targets": 3,
					"searchable": false
