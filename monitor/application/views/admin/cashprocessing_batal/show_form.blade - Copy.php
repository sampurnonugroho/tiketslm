		...
		<?php elseif($state=="ro_atm"): ?>
			...
			<table class="dv-table" style="float:left;border:0px solid #ccc;padding:5px;margin-top:5px;width:auto">
				<tr>
					<td>CART</td>
					<td>:</td>
					<td><input name="bag_seal" style="height: 28px" class="easyui-validatebox easyui-textbox cart_total"></input></td>
				</tr>
				<tr>
					<td>100K</td>
					<td>:</td>
					<td><input name="s100k" style="height: 28px" class="easyui-validatebox tb"></input></td>
				</tr>
				<tr>
					<td>50K</td>
					<td>:</td>
					<td><input name="s50k" style="height: 28px" class="easyui-validatebox tb"></input></td>
				</tr>
				<tr>
					<td>DIV</td>
					<td>:</td>
					<td><input name="divert" style="height: 28px" value="<?=$r['divert']?>" class="easyui-validatebox tb"></input></td>
				</tr>
				<tr>
					<td>BAG SEAL</td>
					<td>:</td>
					...
					for(var i=1; i<=cart; i++) {
						if(i==1) {
							...
							row1 +=   '<tr>'+
								  ...
								  '<td style="border: 0px"><input name="cart_'+i+'_no" style="height: 28px;" value="'+cart_1_no+'" class="easyui-validatebox tb" type="text"></td>'+
								  '</tr>';
						...
						if(i==2) {
							...
							row1 +=   '<tr>'+
								  '<td style="border: 0px">CART '+i+' NO</td>'+
								  '<td style="border: 0px">:</td>'+
								  '<td style="border: 0px"><input name="cart_'+i+'_no" style="height: 28px;" value="'+cart_2_no+'" class="easyui-validatebox tb" type="text"></td>'+
								  '</tr>';
						...
						if(i==3) {
							...
							row1 +=   '<tr>'+
								  '<td style="border: 0px">CART '+i+' NO</td>'+
								  '<td style="border: 0px">:</td>'+
								  '<td style="border: 0px"><input name="cart_'+i+'_no" style="height: 28px;" value="'+cart_3_no+'" class="easyui-validatebox tb" type="text"></td>'+
								  '</tr>';
						...
						if(i==4) {
							...
							row1 +=   '<tr>'+
								  '<td style="border: 0px">CART '+i+' NO</td>'+
								  '<td style="border: 0px">:</td>'+
								  '<td style="border: 0px"><input name="cart_'+i+'_no" style="height: 28px;" value="'+cart_4_no+'" class="easyui-validatebox tb" type="text"></td>'+
								  '</tr>';
