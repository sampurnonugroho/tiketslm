		...
		<section class="grid_8">
			<div class="block-border">
				...
				<form class="block-content form" id="karyawanForm" method="post" action="<?php echo base_url();?><?php echo $url;?>">
					<input required type="hidden" name="id_kategori" id="id_kategori" value="<?php echo $id_kategori;?>" class="full-width">
					
					<fieldset class="grey-bg required">
						<legend><?=ucwords(str_replace("_", " ", $active_menu))?> <?=ucfirst($flag)?></legend>
						
						<p>
							<label for="simple-action">Klasifikasi Troubleshooting</label>
							<input required type="text" name="nama_kategori" id="nama_kategori" value="<?php echo $nama_kategori;?>" class="full-width">
						</p>
